...
const translations: Record<Language, any> = {
  ...
  hi: {
    ...
    viewAll: 'सब देखें',
    revenueVsExpenses: 'कमाई बनाम खर्च',
    // Khata & Customers
    bulkRemind: 'सबको रिमाइंडर',
    nayaGrahak: 'नया ग्राहक',
    import: 'इम्पोर्ट',
    balance: 'बाकी',
    // Expenses
    expenses: 'खर्चा (Expenses)',
    totalExpense: 'कुल खर्चा',
    addExpense: 'खर्चा जोड़ें',
    category: 'श्रेणी',
    notes: 'नोट्स',
    // New Inventory keys
    addItem: 'नया आइटम जोड़ें',
    stockLevel: 'स्टॉक लेवल',
    sku: 'SKU कोड',
    godown: 'गोदाम',
    transfer: 'ट्रांसफर',
    // Staff keys
    addStaff: 'स्टाफ जोड़ें',
    attendance: 'हाजिरी',
    salary: 'सैलरी',
    paySalary: 'सैलरी दें',
