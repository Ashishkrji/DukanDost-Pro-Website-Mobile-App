        ...
        <div className="p-5 border-b border-slate-100 space-y-4">
          <div className="flex flex-col sm:flex-row gap-3 justify-between items-start sm:items-center">
            <SearchInput
              ...
              className="sm:w-80"
            />
            <Button variant="secondary" size="sm" icon={<Download size={14} />} onClick={() => showToast('Invoices exported!')}>
              Export
            </Button>
          </div>
                ...
                <tr key={inv.id} className="hover:bg-orange-50/20 transition-colors block md:table-row">
                  ...
                  <td className="p-4 md:hidden block w-full">
                    ...
                    <div className="flex gap-2 mt-3">
                      ...
                      <button onClick={() => showToast('Invoice shared!')} className="flex-1 py-2 bg-blue-50 text-blue-700 rounded-xl text-xs font-bold">
                        Share PDF
                      </button>
                    </div>
                  </td>
                  ...
                  <td className="px-5 py-4 hidden md:table-cell text-right">
                    <div className="flex justify-end gap-1">
                      ...
                      <button className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-orange-600 rounded-lg hover:bg-orange-50 transition-colors">
